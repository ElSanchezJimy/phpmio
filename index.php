...
<body>
	...
	<img src="logo.png">
		...
		<input type="submit" value="Buscar" name="btnbuscar"><input type="text" name="txtbuscar" id="cajabuscar" placeholder="&#128270;Ingresar nombre de usuario">
			...
			<tr><th colspan="5"><h1>LISTAR USUARIOS</h1><th><a style="font-weight: normal; font-size: 12px;" onclick="abrirform()">Agregar</a></th></tr>
			<tr>
		    <th>Nro</th>
			<th>Código</th>
            <th>Nombre</th>
...
<div class="caja_popup" id="formregistrar">
  <form action="agregar.php" class="contenedor_popup" method="POST">
		...
		<tr><th colspan="2">Nuevo usuario</th></tr>
            ...
            <tr> 
                <td>Teléfono</td>
                <td> <input type="tel" name="txttelefono" required maxlength="8">
